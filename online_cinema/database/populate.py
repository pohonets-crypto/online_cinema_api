...
class CSVDatabaseSeeder:
    ...
    async def seed(self) -> None:
        ...
        It pre-processes the CSV, prepares reference data
        (countries, genres, actors, languages),
        inserts all movies, then inserts many-to-many
        relationships (genres, actors, languages).
        """
        try:
...
async def main() -> None:
    ...
    and if not, performs the seeding process.
    """
